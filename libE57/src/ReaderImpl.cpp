...
namespace e57
{
   ...
   */
                                          ...
                                          int64_t *pointCount ) const
   {
      ...
      std::shared_ptr<CompressedVectorReader> reader = groups.reader( groupSDBuffers );
   ...
   std::shared_ptr<CompressedVectorReader> ReaderImpl::SetUpData3DPointsData(
      int64_t dataIndex, size_t count, const Data3DPointsData_t<COORDTYPE> &buffers ) const
   {
      ...
      std::shared_ptr<CompressedVectorReader> reader = points.reader( destBuffers );
   ...
   template std::shared_ptr<CompressedVectorReader> ReaderImpl::SetUpData3DPointsData(
