...
EMSCRIPTEN_BINDINGS(e57) {
    ...
    value_object<PointStandardizedFieldsAvailable>("PointStandardizedFieldsAvailable")
        .field("cartesianXField", &PointStandardizedFieldsAvailable::cartesianXField)
        .field("cartesianYField", &PointStandardizedFieldsAvailable::cartesianYField)
        .field("cartesianZField", &PointStandardizedFieldsAvailable::cartesianZField)
        .field("cartesianInvalidStateField", &PointStandardizedFieldsAvailable::cartesianInvalidStateField)
        .field("sphericalRangeField", &PointStandardizedFieldsAvailable::sphericalRangeField)
        .field("sphericalAzimuthField", &PointStandardizedFieldsAvailable::sphericalAzimuthField)
        .field("sphericalElevationField", &PointStandardizedFieldsAvailable::sphericalElevationField)
        .field("sphericalInvalidStateField", &PointStandardizedFieldsAvailable::sphericalInvalidStateField)
        .field("pointRangeMinimum", &PointStandardizedFieldsAvailable::pointRangeMinimum)
        .field("pointRangeMaximum", &PointStandardizedFieldsAvailable::pointRangeMaximum)
        .field("pointRangeNodeType", &PointStandardizedFieldsAvailable::pointRangeNodeType)
        .field("pointRangeScale", &PointStandardizedFieldsAvailable::pointRangeScale)
        .field("angleMinimum", &PointStandardizedFieldsAvailable::angleMinimum)
        .field("angleMaximum", &PointStandardizedFieldsAvailable::angleMaximum)
        .field("angleNodeType", &PointStandardizedFieldsAvailable::angleNodeType)
        .field("angleScale", &PointStandardizedFieldsAvailable::angleScale)
        .field("rowIndexField", &PointStandardizedFieldsAvailable::rowIndexField)
        .field("rowIndexMaximum", &PointStandardizedFieldsAvailable::rowIndexMaximum)
        .field("columnIndexField", &PointStandardizedFieldsAvailable::columnIndexField)
        .field("columnIndexMaximum", &PointStandardizedFieldsAvailable::columnIndexMaximum)
        .field("returnIndexField", &PointStandardizedFieldsAvailable::returnIndexField)
        .field("returnCountField", &PointStandardizedFieldsAvailable::returnCountField)
        .field("returnMaximum", &PointStandardizedFieldsAvailable::returnMaximum)
        .field("timeStampField", &PointStandardizedFieldsAvailable::timeStampField)
        .field("isTimeStampInvalidField", &PointStandardizedFieldsAvailable::isTimeStampInvalidField)
        .field("timeMinimum", &PointStandardizedFieldsAvailable::timeMinimum)
        .field("timeMaximum", &PointStandardizedFieldsAvailable::timeMaximum)
        .field("timeNodeType", &PointStandardizedFieldsAvailable::timeNodeType)
        .field("timeScale", &PointStandardizedFieldsAvailable::timeScale)
        .field("intensityField", &PointStandardizedFieldsAvailable::intensityField)
        .field("isIntensityInvalidField", &PointStandardizedFieldsAvailable::isIntensityInvalidField)
        .field("intensityNodeType", &PointStandardizedFieldsAvailable::intensityNodeType)
        .field("intensityScale", &PointStandardizedFieldsAvailable::intensityScale)
        .field("colorRedField", &PointStandardizedFieldsAvailable::colorRedField)
        .field("colorGreenField", &PointStandardizedFieldsAvailable::colorGreenField)
        .field("colorBlueField", &PointStandardizedFieldsAvailable::colorBlueField)
        .field("isColorInvalidField", &PointStandardizedFieldsAvailable::isColorInvalidField)
        .field("normalXField", &PointStandardizedFieldsAvailable::normalXField)
