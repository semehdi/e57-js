...
EMSCRIPTEN_BINDINGS(e57) {
    ...
    class_<Data3D>("Data3D")
        ...
        .property("pose", &Data3D::pose)
        .property("indexBounds", &Data3D::indexBounds)
        .property("cartesianBounds", &Data3D::cartesianBounds)
        .property("sphericalBounds", &Data3D::sphericalBounds)
        .property("intensityLimits", &Data3D::intensityLimits)
        .property("colorLimits", &Data3D::colorLimits)
        .property("pointGroupingSchemes", &Data3D::pointGroupingSchemes)
        .property("pointFields", &Data3D::pointFields)
    ...
    class_<Image2D>("Image2D")
        .property("name", &Image2D::name)
        .property("guid", &Image2D::guid)
        .property("description", &Image2D::description)
        .property("acquisitionDateTime", &Image2D::acquisitionDateTime)
        .property("associatedData3DGuid", &Image2D::associatedData3DGuid)
        .property("sensorVendor", &Image2D::sensorVendor)
        .property("sensorModel", &Image2D::sensorModel)
        .property("sensorSerialNumber", &Image2D::sensorSerialNumber)
        .property("pose", &Image2D::pose)
        .property("visualReferenceRepresentation", &Image2D::visualReferenceRepresentation)
        .property("pinholeRepresentation", &Image2D::pinholeRepresentation)
        .property("cylindricalRepresentation", &Image2D::cylindricalRepresentation);
