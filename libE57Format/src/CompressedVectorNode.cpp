...
CompressedVectorNode::prototype
*/
std::shared_ptr<CompressedVectorReader> CompressedVectorNode::reader( const std::vector<SourceDestBuffer> &dbufs )
{
   return std::make_shared<CompressedVectorReader>(impl_->reader( dbufs ));
}
